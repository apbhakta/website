...
var VK_KB = [
 {k:['early check','check in early','late check out','checkout late','late checkout','early arrival'], w:3,
  a:'Standard times are <strong>check-in 2:00 PM</strong> and <strong>check-out 11:00 AM</strong>. Need to arrive earlier or leave later? Call us at <strong>(254) 675-8999</strong> — we’ll arrange it when we can, subject to availability.', c:['Check-in time','Book a room']},
 {k:['late arrival','arrive late','after midnight','arriving at night','night arrival','coming in late'], w:3,
  a:'No problem at all — our <strong>front desk is staffed 24 hours</strong>, so you can check in any time of night. A quick call to <strong>(254) 675-8999</strong> to let us know helps us have everything ready.', c:['Check-in time','Phone']},
 {k:['truck','trailer','rv','semi','big rig','work truck','equipment','boat trailer'], w:3,
  a:'Yes — our <strong>free on-site parking</strong> has room for work trucks and trailers. Bringing something extra large? Call <strong>(254) 675-8999</strong> ahead and we’ll make sure there’s space.', c:['Parking','Business travel']},
 {k:['wifi password','wi-fi password','internet password','network password','wifi code'], w:4,
  a:'The Wi-Fi is <strong>free in every room</strong> — you’ll receive the network name and password at check-in, and the front desk can help any time if you have connection trouble.', c:['Amenities','Phone']},
 {k:['directions','how do i get','how to get','from waco','from dallas','from fort worth','from austin','navigate','gps'], w:2,
  a:'We’re at <strong>1215 N Avenue G, Clifton, TX 76634</strong> — right on <strong>Highway 6</strong>, an easy drive from Waco, Hillsboro, and Meridian. Pop the address into your GPS, or call <strong>(254) 675-8999</strong> and we’ll talk you down the road.', c:['Location','Explore Clifton']},
 {k:['receipt','invoice','folio','statement','proof of stay','copy of my bill'], w:3,
  a:'Happy to help — call <strong>(254) 675-8999</strong> or email <strong>info@velkommeninncliftontx.com</strong> with your name and stay dates, and we’ll send a copy of your receipt.', c:['Phone','Contact']},
 {k:['lost','left behind','forgot my','left my','lost and found','missing item'], w:2,
  a:'Leave something behind? Call our 24-hour front desk at <strong>(254) 675-8999</strong> with your room number and stay dates — we’ll check lost &amp; found right away.', c:['Phone']},
 {k:['what is for breakfast','whats for breakfast','breakfast menu','breakfast include','waffle','food in the morning','what do you serve'], w:3,
  a:'Our <strong>free continental breakfast (6–9 AM daily)</strong> features a rotating spread — <strong>Texas-shaped waffles</strong>, bagels, muffins, cereal, fresh fruit, juice, and coffee. The perfect send-off before work or the lake.', c:['Breakfast','Amenities']},
 {k:['crib','cribs','rollaway','rollaways','roll away','extra bed','cot','cots','pack n play','baby bed'], w:3,
  a:'Great question — availability of cribs and extra bedding varies, so please call our front desk at <strong>(254) 675-8999</strong> and we’ll do our best to set your room up right.', c:['Room types','Phone']},
 {k:['towel','extra pillow','housekeeping','ice machine','vending','toiletries','blanket','room service'], w:2,
  a:'For any in-stay request — extra towels, pillows, and more — our <strong>24-hour front desk</strong> is happy to help: call <strong>(254) 675-8999</strong> or stop by the lobby.', c:['Phone','Amenities']},
 {k:['movie','cliftex','theater','theatre','cinema'], w:3,
  a:'You’re in luck — the historic <strong>Cliftex Theatre</strong>, a beloved neon-marquee movie house, is minutes away in downtown Clifton. See it and more on our Explore Clifton page.', c:['Explore Clifton','Things to do']},
 {k:['stargazing','observatory','telescope','stars','astronomy','meyer'], w:3,
  a:'The <strong>Paul and Jane Meyer Observatory</strong> near Clifton offers public star-viewing on <strong>scheduled event nights</strong> — check their current schedule before visiting. Central Texas skies are worth it.', c:['Explore Clifton','Things to do']},
 {k:['museum','art','arts center','gallery downtown','culture','paintings'], w:2,
  a:'Clifton has a remarkable arts scene: the <strong>Bosque Museum</strong> (Norwegian &amp; pioneer history), the <strong>Bosque Arts Center</strong>, and the <strong>L.A. Thompson Gallery</strong> — all minutes from the hotel.', c:['Explore Clifton','Things to do']},
 {k:['wedding','weddings','having a wedding','wedding at','wedding party','wedding block','reunion','reunions','family gathering','quincea','party block'], w:6,
  a:'Congratulations! We host <strong>wedding parties, reunions, and group events</strong> with room blocks under one contact and special group pricing — arranged personally by phone at <strong>(254) 675-8999</strong>.', c:['Group stays','Phone']},
 {k:['job','career','hiring','employment','work here','application'], w:3,
  a:'Thanks for your interest in joining the Velkommen Inn team! Please call <strong>(254) 675-8999</strong> or stop by the front desk to ask about current openings.', c:['Phone','Contact']},
 {k:['human','real person','talk to someone','speak to','front desk','live agent','operator'], w:3,
  a:'Of course — real people answer here around the clock. Call our <strong>24-hour front desk at (254) 675-8999</strong>, or use the Contact page to send us a message.', c:['Phone','Contact']},
